...
export default function Settings() {
  ...
  useEffect(() => {
    const savedSettings = {
      ...
      autoNeonite:
        localStorage.getItem("settings.autoNeonite") === "true" || true,
      discordRPC:
        localStorage.getItem("settings.discordRPC") === "true" || true,
    ...
    Object.keys(savedSettings).forEach((key) => {
      if (!localStorage.getItem(`settings.${key}`)) {
        localStorage.setItem(
          `settings.${key}`,
          (savedSettings as any)[key].toString()
        );
      }
    });
        ...
        <div className="absolute inset-0 overflow-y-auto">
          <div className="w-full ml-10 mt-4 max-w-2xl p-5 space-y-6 rounded-lg text-zinc-300">
            <div className="bg-amber-950/50 border border-amber-600/50 p-4 rounded-md flex items-start space-x-3">
              ...
              <p className="text-sm">
                If you don&apos;t know what a setting does, don&apos;t modify
                it. Default settings will always be more optimal for the
                standard user. If you have a question about a setting, please
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex-grow">
                  <h3 className="font-medium bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text">
                    In-Game Username
                  </h3>
                  <p className="text-sm text-zinc-400">
                    Set your in-game display name.
                  </p>
                </div>
                <input
                  type="text"
              ...
              <div className="flex items-center justify-between">
                <div className="flex-grow">
                  <h3 className="font-medium bg-gradient-to-r from-pink-400 via-pink-500 to-purple-600 text-transparent bg-clip-text">
                    AutoNeonite
                  </h3>
                  <p className="text-sm text-zinc-400">
                    Turn on/off automatically launching our backend.
                  </p>
                </div>
                <Toggle
                  checked={settings.autoNeonite}
                  onChange={(value: boolean) =>
                    updateSetting("autoNeonite", value)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-grow">
                  <h3 className="font-medium bg-gradient-to-r from-blue-400 to-indigo-600 text-transparent bg-clip-text">
                    DiscordRPC
                  </h3>
                  <p className="text-sm text-zinc-400">
                    Turn on and off Discord RPC on the Carbon Launcher, requires
                    a restart!{" "}
                  </p>
                </div>
                <Toggle
                  ...
                  onChange={(value: boolean) =>
                    updateSetting("discordRPC", value)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-grow mr-4">
                  <h3 className="font-medium bg-gradient-to-r from-red-400 to-pink-500 text-transparent bg-clip-text">
                    Backend Port
                  </h3>
                  <p className="text-sm text-zinc-400">
                    Modify the port Cranium listens for on launch.
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-grow">
                  <h3 className="font-medium bg-gradient-to-r from-orange-400 to-amber-500 text-transparent bg-clip-text">
                    Always on Top
                  </h3>
                  <p className="text-sm text-zinc-400">
                    Launcher will always display on top.
                  </p>
                </div>
                <Toggle

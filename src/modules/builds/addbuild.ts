            ...
            if (match && !str.includes("Live") && !str.includes("Cert")) {
                ...
                if (match) {
                    switch (parseInt(match[2])) {
                        ...
                        case 3847564: { version = "2.3"; release = "2.3-CL-3847564"; foundMatch = true; break; }
                        case 3841827: { version = "2.2"; release = "2.2-CL-3841827"; foundMatch = true; break; }
                        case 3825894: { version = "2.1"; release = "2.1-CL-3825894"; foundMatch = true; break; }
                        case 3807424: { version = "1.11"; release = "1.11-CL-3807424"; foundMatch = true; break; }
                        case 3790078: { version = "1.10"; release = "1.10-CL-3790078"; foundMatch = true; break; }
                        case 3775276: { version = "1.91"; release = "1.91-CL-3775276"; foundMatch = true; break; }
                        case 3757339: { version = "1.9"; release = "1.9-CL-3757339"; foundMatch = true; break; }
                        case 3729133: { version = "1.8.1"; release = "1.81-CL-3729133"; foundMatch = true; break; }
                        case 3724489: { version = "1.8"; release = "1.8-CL-3724489"; foundMatch = true; break; }
                        case 3700114: { version = "1.7.2"; release = "1.72-CL-3700114"; foundMatch = true; break; }
                        case 3541083: { version = "1.2"; release = "1.2-CL-3541083"; foundMatch = true; break; }
                        case 3532353: { version = "1.0"; release = "1.0-CL-3532353"; foundMatch = true; break; }
                    }
                    break;
                }
            }
